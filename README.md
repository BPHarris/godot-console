...
- `command_arguments` : The names and types of the command/method arguments (default = `[]`) (type: `Array[Array[argument_name : String, argument_type : Type]]`)
...
It's *that* simple! For more example see `add_default_commands` and `_command_*` in `./Console.gd`.
